...
object ArenaSessionCodec {
    ...
    private val WAVES_DATA_MAP_CODEC = MapCodec<WaveCurrentData?, ConcurrentHashMap<String, WaveCurrentData?>>(
        WaveCurrentDataCodec.CODEC as Codec<WaveCurrentData?>,
